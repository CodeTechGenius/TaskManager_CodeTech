<script>
  ...
  function validateStep(step) {
    ...
    switch (step) {
      case 1:
        ...
        if (!projectData.projectCode.trim())
      ...
      case 2:
        ...
        break;
      case 3:
        if (projectData.frontend.length === 0)
          errors.frontend = "Select at least one frontend technology";
        if (projectData.backend.length === 0)
          errors.backend = "Select at least one backend technology";
        if (projectData.database.length === 0)
          errors.database = "Select at least one database";
        break;
      case 4:
        if (!projectData.projectManager)
          errors.projectManager = "Project manager is required";
        if (projectData.assignedEmployees.length === 0)
          errors.assignedEmployees = "Assign at least one team member";
        break;
      case 5:
  ...
  function toggleEmployee(employeeId) {
    ...
    if (index > -1) {
      projectData.assignedEmployees = projectData.assignedEmployees.filter(
        (id) => id !== employeeId,
      );
    } else {
  ...
  async function submitProject() {
    ...
    // validate all required steps (1..5) before submit
    ...
    saving = true;
    try {
      let { error, id } = await api.addProject({ projectData });
      if(error){
        return
      }
      // ✅ success: go to dashboard or a project detail page
      // goto(`/admin/projects/${result.id}`);
...
<!-- Mobile Top Navbar -->
<nav
  class="lg:hidden sticky top-0 z-50 bg-gradient-to-r from-primary-600 via-primary-700 to-primary-600 shadow-2xl"
>
  <div class="flex items-center justify-between px-4 py-4">
    ...
    <div class="flex-1 mx-4">
      ...
      <p class="text-xs text-primary-100 text-center font-semibold">
        Step {currentStep} of {totalSteps}
      </p>
    </div>

    <div
      class="w-10 h-10 rounded-xl bg-white/20 backdrop-blur-md border border-white/20 flex items-center justify-center"
    >
...
<!-- Desktop Header -->
<div
  class="hidden lg:block bg-gradient-to-br from-neutral-50 to-neutral-100 dark:from-neutral-950 dark:to-neutral-900 border-b-2 border-neutral-200 dark:border-neutral-800"
>
  <div class="max-w-6xl mx-auto px-8 py-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1
          class="text-4xl font-black text-neutral-900 dark:text-white mb-2 flex items-center gap-3"
        >
          <div
            class="w-14 h-14 bg-gradient-to-br from-primary-500 to-primary-600 rounded-2xl flex items-center justify-center shadow-xl"
          >
            <svg
        ...
        <p class="text-neutral-600 dark:text-neutral-400 font-semibold">
          Complete all steps to create your project
        </p>
      </div>
      <div class="text-right">
        <div
          class="text-5xl font-black bg-gradient-to-r from-primary-600 to-primary-700 bg-clip-text text-transparent"
        >
...
<!-- Main Container -->
<div
  class="min-h-screen bg-gradient-to-br from-neutral-50 via-neutral-100 to-neutral-200 dark:from-neutral-950 dark:via-neutral-900 dark:to-neutral-800 pb-32 lg:pb-8"
>
  <div class="max-w-6xl mx-auto px-4 lg:px-8 py-6 lg:py-8">
    <!-- Desktop Step Progress -->
    <div
      class="hidden lg:block bg-white dark:bg-neutral-800 rounded-3xl shadow-2xl border-2 border-neutral-200 dark:border-neutral-700 p-8 mb-8"
    >
      <div class="relative">
        <!-- Progress Line -->
        <div
          class="absolute top-12 left-0 right-0 h-2 bg-neutral-200 dark:bg-neutral-700 rounded-full"
        >
          <div
          ...
          {#each Array(totalSteps) as _, i}
            ...
            >
              <div class="relative z-10">
                <div
                  class="w-24 h-24 rounded-2xl flex items-center justify-center font-black text-lg transition-all shadow-xl {i +
                    1 ===
                  currentStep
              ...
              <div class="text-center">
                <p
                  class="text-xs font-bold {i + 1 === currentStep
                    ? 'text-primary-600'
    ...
    <div class="lg:hidden mb-6">
      <div
        class="bg-white dark:bg-neutral-800 rounded-2xl shadow-xl border-2 border-neutral-200 dark:border-neutral-700 p-4"
      >
        <div class="flex items-center gap-3 mb-4">
          <div
            class="w-14 h-14 bg-gradient-to-br from-primary-500 via-primary-600 to-primary-700 rounded-xl flex items-center justify-center shadow-lg"
          >
            <svg
              class="w-8 h-8 text-white"
              fill="none"
          ...
          <div class="flex-1">
            ...
            <p
              class="text-sm text-neutral-600 dark:text-neutral-400 font-semibold"
            >
              Step {currentStep} of {totalSteps}
            </p>
          </div>
        ...
        <div class="flex gap-2 justify-center">
          {#each Array(totalSteps) as _, i}
            <button
              on:click={() => goToStep(i + 1)}
              class="transition-all {i + 1 === currentStep
                ? 'w-8 h-2 bg-gradient-to-r from-primary-500 to-primary-600'
                : i + 1 < currentStep
                  ? 'w-2 h-2 bg-success-500'
                  : 'w-2 h-2 bg-neutral-300 dark:bg-neutral-600'} rounded-full"
            ></button>
          {/each}
        </div>
      </div>
    ...
    <!-- Form Container -->
    <div
      class="bg-white dark:bg-neutral-800 rounded-3xl shadow-2xl border-2 border-neutral-200 dark:border-neutral-700 overflow-hidden"
    >
        ...
        {#if currentStep === 1}
          <div in:fly={{ x: 20, duration: 400, easing: cubicOut }}>
            <div class="space-y-5">
              ...
              <div>
                <label
                  class="block text-sm font-bold text-neutral-700 dark:text-neutral-300 mb-2 flex items-center gap-2"
                >
                ...
                <input
                  ...
                  class="w-full px-4 py-4 rounded-xl border-2 {showErrors &&
                  errors.projectName
                    ? 'border-error-500 shake'
                    : 'border-neutral-300 dark:border-neutral-600'} bg-white dark:bg-neutral-900 text-neutral-900 dark:text-white focus:border-primary-500 focus:ring-4 focus:ring-primary-100 dark:focus:ring-primary-900/30 transition-all font-semibold text-base"
                />
                {#if showErrors && errors.projectName}
                  <p
                    class="mt-2 text-sm text-error-600 dark:text-error-400 font-semibold flex items-center gap-1"
                  >
                    <svg
                      class="w-4 h-4"
                      fill="none"
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    ...
                    errors.projectCode
                      ? 'border-error-500'
                      : 'border-neutral-300 dark:border-neutral-600'} bg-white dark:bg-neutral-900 text-neutral-900 dark:text-white focus:border-primary-500 focus:ring-4 focus:ring-primary-100 transition-all font-bold uppercase text-base"
                  />
                  {#if showErrors && errors.projectCode}
                    <p class="mt-2 text-sm text-error-600 font-semibold">
                      {errors.projectCode}
                    </p>
                  {/if}
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    errors.category
                      ? 'border-error-500'
                      : 'border-neutral-300 dark:border-neutral-600'} bg-white dark:bg-neutral-900 text-neutral-900 dark:text-white focus:border-primary-500 focus:ring-4 focus:ring-primary-100 transition-all font-semibold text-base"
                  >
              ...
              <div>
                <label
                  class="block text-sm font-bold text-neutral-700 dark:text-neutral-300 mb-2"
                >
                  Project Description
                </label>
                <textarea
              ...
              <div>
                <label
                  class="block text-sm font-bold text-neutral-700 dark:text-neutral-300 mb-3"
                >
                  Priority Level
                </label>
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  {#each priorityOptions as priority}
                    <button
                      ...
                      class="px-5 py-4 rounded-xl border-2 font-bold text-base capitalize transition-all {projectData.priority ===
                      priority
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  {#each statusOptions as status}
                    <button
                      ...
                      class="px-5 py-4 rounded-xl border-2 font-bold text-base capitalize transition-all {projectData.status ===
                      status
          ...
          <div in:fly={{ x: 20, duration: 400, easing: cubicOut }}>
            <div class="space-y-5">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    errors.startDate
                      ? 'border-error-500'
                      : 'border-neutral-300 dark:border-neutral-600'} bg-white dark:bg-neutral-900 text-neutral-900 dark:text-white focus:border-success-500 focus:ring-4 focus:ring-success-100 transition-all font-semibold text-base"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    errors.estimatedEndDate
                      ? 'border-error-500'
                      : 'border-neutral-300 dark:border-neutral-600'} bg-white dark:bg-neutral-900 text-neutral-900 dark:text-white focus:border-warning-500 focus:ring-4 focus:ring-warning-100 transition-all font-semibold text-base"
                  />
              ...
              <div class="mt-6">
                ...
                <div
                  class="bg-neutral-50 dark:bg-neutral-900 rounded-2xl p-4 border-2 border-neutral-200 dark:border-neutral-700 mb-4"
                >
                  <div class="space-y-3">
                    <input
                      type="text"
                ...
                {#if milestones.length > 0}
                  <div class="space-y-2">
                    {#each milestones as milestone (milestone.id)}
                      <div
                        class="bg-white dark:bg-neutral-900 rounded-xl p-4 border-2 border-neutral-200 dark:border-neutral-700 flex items-center justify-between"
                      >
                        <div class="flex-1">
        ...
        {#if currentStep === 3}
          <div in:fly={{ x: 20, duration: 400, easing: cubicOut }}>
            <div class="space-y-6">
              ...
              <div>
                <label
                  class="block text-base font-bold text-neutral-900 dark:text-white mb-3 flex items-center gap-2"
                >
                  <div
                ...
                >
                  {#each techStacks.frontend as tech}
                    <button
                      ...
                      class="px-4 py-3 rounded-xl border-2 font-semibold text-sm transition-all active:scale-95 {projectData.frontend.includes(
                        tech,
                      )
              ...
              <div>
                ...
                >
                  <div
                    class="w-8 h-8 bg-secondary-100 dark:bg-secondary-900/30 rounded-lg flex items-center justify-center"
                  >
                    <svg
                ...
                >
                  {#each techStacks.backend as tech}
                    <button
                      ...
                      class="px-4 py-3 rounded-xl border-2 font-semibold text-sm transition-all active:scale-95 {projectData.backend.includes(
                        tech,
                      )
              ...
              <div>
                ...
                >
                  <div
                    class="w-8 h-8 bg-accent-100 dark:bg-accent-900/30 rounded-lg flex items-center justify-center"
                  >
                    <svg
                      class="w-5 h-5 text-accent-600"
                      fill="none"
                ...
                >
                  {#each techStacks.database as tech}
                    <button
                      ...
                      class="px-4 py-3 rounded-xl border-2 font-semibold text-sm transition-all active:scale-95 {projectData.database.includes(
                        tech,
                      )
              ...
              <div>
                ...
                >
                  <div
                    class="w-8 h-8 bg-success-100 dark:bg-success-900/30 rounded-lg flex items-center justify-center"
                  >
                    <svg
                ...
                >
                  {#each techStacks.deployment as tech}
                    <button
                      ...
                      class="px-4 py-3 rounded-xl border-2 font-semibold text-sm transition-all active:scale-95 {projectData.deployment.includes(
                        tech,
                      )
              ...
              <div>
                ...
                >
                  <div
                    class="w-8 h-8 bg-info-100 dark:bg-info-900/30 rounded-lg flex items-center justify-center"
                  >
                    <svg
                ...
                >
                  {#each techStacks.tools as tech}
                    <button
                      ...
                      class="px-4 py-3 rounded-xl border-2 font-semibold text-sm transition-all active:scale-95 {projectData.otherTools.includes(
                        tech,
                      )
        ...
        {#if currentStep === 4}
          <div in:fly={{ x: 20, duration: 400, easing: cubicOut }}>
            <div class="space-y-5">
              ...
              <div>
                <label
                  class="block text-base font-bold text-neutral-900 dark:text-white mb-4 flex items-center gap-2"
                >
                  <svg
                    class="w-5 h-5 text-primary-600"
                    fill="none"
                ...
                <div class="grid grid-cols-1 gap-3">
                  {#each employees as employee}
                    <button
                      ...
                      class="flex items-center gap-4 p-4 rounded-2xl border-2 transition-all active:scale-98 {!employee.id
                    ...
                    >
                      <div
                        class="w-12 h-12 rounded-xl bg-gradient-to-br from-primary-400 to-accent-500 flex items-center justify-center text-white font-black text-lg shadow-lg"
                      >
                        {employee.avatar}
                      </div>
                      ...
                      <!-- {#if employee.available}
                        <div
                          class="w-6 h-6 rounded-lg border-2 flex items-center justify-center transition-all {projectData.assignedEmployees.includes(
                            employee.id,
                          )
                      ...
                      {:else}
                        <span
                          class="px-3 py-1 bg-error-100 dark:bg-error-900/30 text-error-700 dark:text-error-400 text-xs font-bold rounded-full"
                        >
                          Unavailable
                        </span>
                      {/if} -->
                ...
                {#if projectData.assignedEmployees.length > 0}
                  <div
                    class="mt-4 p-4 bg-success-50 dark:bg-success-900/20 border-2 border-success-300 dark:border-success-700 rounded-xl"
                  >
                    <p
                      class="text-success-700 dark:text-success-400 font-bold flex items-center gap-2"
                    >
                      <svg
                        class="w-5 h-5"
                        fill="none"
                      ...
                      {projectData.assignedEmployees.length} member{projectData
        ...
        {#if currentStep === 5}
          <div in:fly={{ x: 20, duration: 400, easing: cubicOut }}>
            <div class="space-y-5">
              <!-- Client Info -->
              <div
                class="bg-gradient-to-r from-accent-50 to-primary-50 dark:from-accent-950/30 dark:to-primary-950/30 rounded-2xl p-5 border-2 border-accent-200 dark:border-accent-800"
              >
                <h3
                  class="text-lg font-bold text-neutral-900 dark:text-white mb-4 flex items-center gap-2"
                >
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      class="w-full px-4 py-3 rounded-xl border-2 {showErrors &&
                      errors.clientName
                        ? 'border-error-500'
                        : 'border-neutral-300 dark:border-neutral-600'} bg-white dark:bg-neutral-900 text-neutral-900 dark:text-white focus:border-accent-500 focus:ring-4 focus:ring-accent-100 transition-all font-semibold"
                    />
              ...
              <div>
                <label
                  class="block text-base font-bold text-neutral-900 dark:text-white mb-4"
                >
                  Billing Type
                </label>
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <button
                    ...
                    class="p-5 rounded-2xl border-2 transition-all active:scale-95 {projectData.billingType ===
                    'fixed'
                      ? 'bg-primary-50 dark:bg-primary-900/20 border-primary-500 shadow-xl'
                      : 'border-neutral-300 dark:border-neutral-600 hover:border-primary-400'}"
                  >
                    <div
                      class="w-12 h-12 rounded-xl bg-primary-500 text-white flex items-center justify-center mb-2 mx-auto"
                    >
                      <svg
                        class="w-6 h-6"
                        fill="none"
                  ...
                  >
                    <div
                      class="w-12 h-12 rounded-xl bg-secondary-500 text-white flex items-center justify-center mb-2 mx-auto"
                    >
                      <svg
                        class="w-6 h-6"
                        fill="none"
                  ...
                  >
                    <div
                      class="w-12 h-12 rounded-xl bg-accent-500 text-white flex items-center justify-center mb-2 mx-auto"
                    >
                      <svg
                        class="w-6 h-6"
                        fill="none"
                ...
                <div>
                  ...
                  <div class="relative">
                    <input
                      ...
                      placeholder="0"
                      class="w-full pl-12 pr-4 py-4 rounded-xl border-2 {showErrors &&
                      errors.totalBudget
                        ? 'border-error-500'
                        : 'border-neutral-300 dark:border-neutral-600'} bg-white dark:bg-neutral-900 text-neutral-900 dark:text-white focus:border-primary-500 focus:ring-4 focus:ring-primary-100 transition-all font-bold text-lg"
                    />
                    <span
                      class="absolute left-4 top-1/2 -translate-y-1/2 text-neutral-500 font-bold text-lg"
                      >₹</span
                    >
                  </div>
                ...
                {#if projectData.billingType === "hourly"}
                  <div>
                    ...
                    <div class="relative">
                      ...
                      >
                      <span
                        class="absolute right-4 top-1/2 -translate-y-1/2 text-neutral-500 font-semibold"
                        >/hr</span
                      >
                    </div>
                  </div>
          ...
          <div in:fly={{ x: 20, duration: 400, easing: cubicOut }}>
            <div class="space-y-5">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-6">
                <div
                  class="bg-gradient-to-br from-success-50 to-success-100 dark:from-success-950/30 dark:to-success-900/30 rounded-xl p-4 border-2 border-success-300 dark:border-success-700"
                >
                  <div
                    class="w-10 h-10 bg-success-500 rounded-lg flex items-center justify-center mb-2"
                  >
                    <svg
                  ...
                  <h4
                    class="font-bold text-success-900 dark:text-success-300 text-sm"
                  >
                    SSL Certificate
                  </h4>
                ...
                <div
                  class="bg-gradient-to-br from-info-50 to-info-100 dark:from-info-950/30 dark:to-info-900/30 rounded-xl p-4 border-2 border-info-300 dark:border-info-700"
                >
                  <div
                    class="w-10 h-10 bg-info-500 rounded-lg flex items-center justify-center mb-2"
                  >
                    <svg
                      class="w-5 h-5 text-white"
                      fill="none"
                  ...
                  <h4
                    class="font-bold text-info-900 dark:text-info-300 text-sm"
                  >
                    Backup System
                  </h4>
                  <p class="text-xs text-info-700 dark:text-info-400">
                    Daily backups
                  </p>
                </div>

                <div
                  class="bg-gradient-to-br from-warning-50 to-warning-100 dark:from-warning-950/30 dark:to-warning-900/30 rounded-xl p-4 border-2 border-warning-300 dark:border-warning-700"
                >
                  <div
                    class="w-10 h-10 bg-warning-500 rounded-lg flex items-center justify-center mb-2"
                  >
                    <svg
                      class="w-5 h-5 text-white"
                      fill="none"
                  ...
                  <h4
                    class="font-bold text-warning-900 dark:text-warning-300 text-sm"
                  >
                    Auto Scaling
                  </h4>
      ...
      <div
        class="sticky bottom-0 left-0 right-0 bg-white dark:bg-neutral-800 border-t-2 border-neutral-200 dark:border-neutral-700 p-4 -mx-4 -mb-10 sm:-mx-6 lg:relative lg:mx-0 lg:mb-0 lg:mt-8 lg:border-t-0 lg:pt-8 lg:p-0"
      >
