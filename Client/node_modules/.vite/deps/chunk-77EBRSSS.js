...
function attribute_effect(element2, fn, thunks = [], css_hash, skip_warning = false, d = derived) {
  ...
  var inited = false;
  block(() => {
    var next2 = fn(...deriveds.map(get));
    set_attributes(element2, prev, next2, css_hash, skip_warning);
...
//# sourceMappingURL=chunk-77EBRSSS.js.map
