...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/(superadmin)" | "/(employee)" | "/(auth)" | "/(admin)" | "/" | "/(admin)/admin" | "/(admin)/admin/dashboard" | "/(admin)/admin/profile" | "/(admin)/admin/projects" | "/(admin)/admin/projects/new" | "/(admin)/admin/projects/[id]" | "/(admin)/admin/reports" | "/(admin)/admin/tasks" | "/(admin)/admin/tasks/new" | "/(admin)/admin/tasks/[id]" | "/(admin)/admin/team" | "/(admin)/admin/team/[id]" | "/(employee)/employee" | "/(employee)/employee/dashboard" | "/(employee)/employee/profile" | "/(employee)/employee/projects" | "/(employee)/employee/tasks" | "/(employee)/employee/timesheet" | "/(auth)/login" | "/(auth)/login/admin" | "/(auth)/login/employee" | "/(superadmin)/superadmin";
		RouteParams(): {
